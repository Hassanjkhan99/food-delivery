...
export default function RestaurantLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-neutral-100">
      <aside className="hidden w-52 shrink-0 border-r border-neutral-200 bg-white p-4 sm:block">
        ...
        <Link href="/" className="mt-8 block text-xs text-neutral-400 hover:text-neutral-600">
          ← Customer site
        </Link>
      </aside>
